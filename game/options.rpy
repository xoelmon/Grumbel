...
define config.name = _("GRUMBREL el pequenho ogro")
...
define config.version = "BETA-2.3"


## Texto situado en la pantalla 'Acerca de' del juego. Sitúa el texto entre
## comillas triples y deja una línea en blanco entre párrafos.

define gui.about = _p("""Este juego ha sido desarrollado por DEMO para rpmi
""")
...
define config.save_directory = "GRUMBRELelpequenhoogro-1716124715"
